<template>
  <div class="dark:bg-darker-blue dark:text-white">
    <button
      :class="[
        'back-btn bg-white dark:bg-dark-blue dark:text-white',
        'btn-container',
      ]"
      @click="returnHome"
    >
      <img class="arrow" src="images/arrow.png" alt="arrow-icon" />
  ...
  <div class="details dark:bg-darker-blue dark:text-white">
    ...
    <div>
      ...
      <p
        ...
        :key="key"
        class="detail-list font-semibold"
      >
        <span v-if="detail" class="font-bold"
